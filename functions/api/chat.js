...
Practice Areas: Estate Planning (wills, trusts, POA, healthcare directives — flat fee), Probate & Estate Administration (Register of Wills, Letters Testamentary, inheritance tax, distribution), Real Estate (settlements, title searches and title work for our closings, title insurance via Chicago Title & First American, buyer rep, FSBO — we perform title searches and handle title work for closings we manage; we do not do standalone title opinions or opinions of counsel), Business Law (LLC, corp, partnerships, contracts, leases), Elder Law (Medicaid planning, asset protection, guardianship).
